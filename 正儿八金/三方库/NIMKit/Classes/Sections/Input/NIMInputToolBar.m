...
{
    self.inputTextView.placeholderAttributedText = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@",placeHolder] attributes:@{NSForegroundColorAttributeName:[UIColor grayColor]}];
}
