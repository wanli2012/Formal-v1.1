...
//        [self addSubview:_avatarImageView];
        ...
        _imagev = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 40, 40)];
...
- (void)layoutSubviews{
    ...
    _imagev.nim_left    = sessionListAvatarLeft;
    _imagev.nim_centerY = self.nim_height * .5f;
    _nameLabel.nim_top           = sessionListNameTop;
    _nameLabel.nim_left          = _imagev.nim_right + sessionListNameLeftToAvatar;
    _messageLabel.nim_left       = _imagev.nim_right + sessionListMessageLeftToAvatar;
