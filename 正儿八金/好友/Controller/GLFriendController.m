...
- (void)viewDidLoad {
    ...
    self.sessionListVc.view.frame = CGRectMake(0,165,kSCREEN_WIDTH , kSCREEN_HEIGHT - 165);
    [self addChildViewController:self.sessionListVc];
    
    self.contactVc = [[NTESContactViewController alloc] init];
    self.contactVc.view.frame = CGRectMake(0, 165, kSCREEN_WIDTH, kSCREEN_HEIGHT - 165);
...
//                [self.navigationController showViewController:vc sender:nil];
                [self.view makeToast:@"创建成功，快去聊天吧" duration:2.0 position:CSToastPositionCenter];
...
-(LBGoodFriendsHeaderView*)goodFriendsHeaderView{
    ...
    if (!_goodFriendsHeaderView) {
        ...
        _goodFriendsHeaderView.frame = CGRectMake(0, 64, kSCREEN_WIDTH, 50);
...
-(LBGoodFriendsSectionView*)goodFriendsSectionView{
    ...
    if (!_goodFriendsSectionView) {
        ...
        _goodFriendsSectionView = ({
            ...
            view.frame = CGRectMake(0, 115,kSCREEN_WIDTH , 50);
