...
@interface GLHome_Search_Post : NSObject

@property (nonatomic, strong)NSString *title;//帖子标题post_id
...
@interface GLHome_Search_PostModel : NSObject
...
@property (nonatomic, strong)GLHome_Search_Post *post;
